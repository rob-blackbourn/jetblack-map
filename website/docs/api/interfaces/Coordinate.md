...
[types.ts:11](https://github.com/rob-blackbourn/jetblack-map/blob/74a170a/src/types.ts#L11)
...
[types.ts:16](https://github.com/rob-blackbourn/jetblack-map/blob/74a170a/src/types.ts#L16)
